...
from prolothar_rule_mining.models.event_flow_graph.alignment.greedy_beam_search import GreedyBeamSearch
...
class TestGreedyBeamSearch(unittest.TestCase):
    ...
    def test_compute_alignment_bac(self):
        ...
        alignment_finder = GreedyBeamSearch(
            self.graph,
            MaximumHeuristic([

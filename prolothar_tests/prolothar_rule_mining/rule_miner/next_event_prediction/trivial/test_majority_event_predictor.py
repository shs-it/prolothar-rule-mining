...
from prolothar_rule_mining.rule_miner.next_event_prediction.trivial import MajorityEventPredictor
from prolothar_rule_mining.rule_miner.next_event_prediction.eventlog_iterator import eventlog_iterator

class TestMajorityEventPredictor(unittest.TestCase):
    ...
    def test_on_simple_dataset(self):
        ...
        predictor = MajorityEventPredictor()

...
from prolothar_rule_mining.rule_miner.data_to_sequence.classification_miner import ClassificationMiner
...
class TestClassificationMiner(unittest.TestCase):
    ...
    def test_mine_rules(self):
        mined_rule = ClassificationMiner(ReliableRuleMiner()).mine_rules(self.dataset)

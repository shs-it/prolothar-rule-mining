...
from prolothar_rule_mining.rule_miner.data_to_sequence.consequence.event_flow_graph_miner import SequenceAlignmentNoMdl
...
class TestSequenceBottomUpEventFlowGraphMiner(unittest.TestCase):
    ...
    def test_mine_event_flow_graph(self):
        ...
        event_flow_graph = SequenceAlignmentNoMdl().mine_event_flow_graph(dataset)
